  ...
  return (
    <div className='maincontent'>
        ...
        <div className='leftcontent'>
            ...
            <h3>Schedule your tasks to complete </h3>
        ...
        <div className='rightcontent'>
          ...
          {/* header */}
           ...
           <h1>My Tasks</h1>
           <h3><i>"Consistency is the Key to Success"</i></h3>


           <div className='inputcontent'>
               <input type="text" placeholder='Enter your tasks here'  value={Newtask} onChange={Inputchange}/>
